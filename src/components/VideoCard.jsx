...
const VideoCard = () => {
  ...
  const fetchVideos = async () => {
    try {
      ...
      const videosWithLikes = data.map((v) => ({
        ...v,
        likes: v.likes || 0,
      }));
    ...
    <div className="px-6 pb-28">
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 max-w-6xl mx-auto">
        {limitedVideos.map((video) => (
          <div
            key={video.id}
            className="relative group overflow-hidden rounded-2xl shadow-xl bg-white/80 backdrop-blur-md transition-transform hover:scale-[1.02]"
          >
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between items-center text-sm text-gray-500 mt-3 pt-2 border-t">
                ...
                <button
                  ...
                  className="cursor-pointer flex items-center gap-1 z-10 relative"
                >
